...
public class TributasLogWriter implements ILogWriter {
		...
		//Objeto para sincronización, se necesita para construir los directorios.
		...
		public synchronized void doLog(String message, NIVEL_LOG level)
		{
	        ...
	        try
	        {
	            ...
	            //fichero = new FileWriter(this.ficheroLog,true);//true para que agregemos al final del fichero
	            if (charsetName !=null)
	            {
